          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Racikan kopi klasik adalah keindahan sederhana yang menciptakan kenikmatan yang mendalam. Dibuat dengan cermat dan disajikan dengan kasih sayang, kopi klasik memberikan pengalaman yang memuaskan bagi para pencinta kopi.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    Caramel Latte, secangkir kelezatan yang memikat hati dengan kombinasi yang sempurna antara kopi yang kaya dan manisnya karamel.
                    </p>
                  </div>
                </div>
              </div>
